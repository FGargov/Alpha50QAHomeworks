...
public final class EngineImpl implements Engine {
    ...
    private static final String COMMAND_EXECUTION_ERROR = "An error occurred during command execution: %s";
    ...
    private void processCommand(String inputLine) {
        ...
        try {
            ...
            System.out.println(String.format(COMMAND_EXECUTION_ERROR, e.getMessage()));
        }
    }
