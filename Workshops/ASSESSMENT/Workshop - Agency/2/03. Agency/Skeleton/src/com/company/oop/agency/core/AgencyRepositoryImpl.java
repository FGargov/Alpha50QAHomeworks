...
public class AgencyRepositoryImpl implements AgencyRepository {
    ...
    public Airplane createAirplane(int passengerCapacity, double pricePerKilometer, boolean hasFreeFood) {
        Airplane airplane = new AirplaneImpl(++AirplaneImpl.NEXT_ID, passengerCapacity, pricePerKilometer, hasFreeFood);
    ...
    public Bus createBus(int passengerCapacity, double pricePerKilometer) {
        Bus bus = new BusImpl(++BusImpl.NEXT_ID, passengerCapacity, pricePerKilometer);
    ...
    public Train createTrain(int passengerCapacity, double pricePerKilometer, int carts) {
        Train train = new TrainImpl(++TrainImpl.NEXT_ID, passengerCapacity, pricePerKilometer, carts);
    ...
    public Journey createJourney(String startLocation, String destination, int distance, Vehicle vehicle) {
        Journey journey = new JourneyImpl(++BusImpl.NEXT_ID, startLocation, destination, distance, vehicle);
    ...
    public Ticket createTicket(Journey journey, double costs) {
        Ticket ticket = new TicketImpl(++BusImpl.NEXT_ID, journey, costs);
